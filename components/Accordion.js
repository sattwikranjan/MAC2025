        ...
        >
          ...
          >
            {memberdata.map((member) => (
              ...
              >
                <span
                  className={`w-[55vw] md:text-[16px] lg:text-lg lg:p-2 ${
                    member.fullName === "Dr. Rajan Mishra (Chair)"
                      ? "font-extrabold"
                      : ""
                  }`}
                >
                ...
                <span className="w-[35vw] md:text-[16px] lg:text-lg lg:p-2  italic text-left font-normal">
                  {" "}
                  {member.organisation}
                </span>
              </motion.div>
