...
const Keynote = (props) => {
  return (
    <div
      className={`mx-auto md:mx-12 flex px-0  my-8 hover:shadow-inner  md:flex-row flex-col items-center card bg-stone-100 p-4 shadow-inner  ${cool.coolHover}`}
    >
      <div className=" mb-10 md:mb-0 w-auto md:w-[30%] xl:w-[25%] flex justify-center">
        <img
          alt="humanImage"
          src={props.profileImage}
          className="object-fill  rounded-lg w-52 h-52  "
        ></img>
      </div>
      <div className=" w-auto  md:w-[70%] xl:w-[75%] lg:pl-8 md:pl-4 flex flex-col md:items-start md:text-left items-center text-center">
        <h1 className="title-font text-2xl  font-bold text-gray-900">
          {props.fullName}
        </h1>
        {/* mb-2 karni hai */}
        ...
        <Link href={props.url}>
          <a className="text-orange-600 inline-flex items-center md:mb-2 lg:mb-0 mt-2">
            View Profile
